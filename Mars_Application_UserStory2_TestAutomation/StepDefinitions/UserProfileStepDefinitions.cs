...
namespace Mars_Application_UserStory2_TestAutomation.Mars_ApplicationStepDefinitions
{
    ...
    public class UserProfileStepDefinitions
    {
        ...
        public void ThenApplicationEditsTheLanuageDetailsForTheUser(string language, string p1)
        {
        ...
        [Given(@"User enters new skills detais '([^']*)' '([^']*)'and clicks on Add new button")]
        ...
        [When(@"User enters a duplciate Language details '([^']*)' '([^']*)' and clicks on Add New button")]
